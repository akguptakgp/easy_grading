...
def data_manipulation():
    Acc=[ [ (0.0,j-3) for j in range(3,58)] for i in [1,2,3,4,5,6,7,8]]
    print Acc
    for j in range(3,58):
        ...
        for i in [1,2,3,4,5,6,7,8]: #to change after feature extraction done for all sets
            ...
            with open('/home/ankit/Automated_Essay_Grading/experiment/experiment_'+str(j)+'_features_'+str(i)+'.csv','r') as in_file:
            ...
            Acc[i-1][j-3]=(np.average(linear_accuracy),j-3)
            print 
    print Acc
    print "super"
